...
import 'marcas_rail_widget.dart';
                ...
                child: ConstrainedBox(
                  ...
                  child: IntrinsicHeight(
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination("McDonalds", padding),
                        buildRotatedTextRailDestination("Bobs", padding),
                        buildRotatedTextRailDestination("Spoleto", padding),
                        buildRotatedTextRailDestination("KFC", padding),
                        buildRotatedTextRailDestination("Hashi Time", padding),
                        buildRotatedTextRailDestination("Burger King", padding),
                        buildRotatedTextRailDestination("Subway", padding),
